...
@Repository
public interface bill_detail_Repository extends JpaRepository<Bill_Details, String> {
    ...
    @Query("SELECT bd FROM Bill_Details bd WHERE bd.bills.bill_id= :bill_id")
    List<Bill_Details> findByBillId(String bill_id);
}
